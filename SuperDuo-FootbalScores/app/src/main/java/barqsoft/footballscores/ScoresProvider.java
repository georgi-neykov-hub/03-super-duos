...
public class ScoresProvider extends ContentProvider
{
    ...
    private static final String SCORES_BY_LEAGUE = DatabaseContract.ScoresItem.LEAGUE_ID + " = ?";
    private static final String SCORES_BY_DATE =
            DatabaseContract.ScoresItem.DATE + " LIKE ?";
    private static final String SCORES_BY_ID =
            DatabaseContract.ScoresItem.MATCH_ID + " = ?";
    ...
    private int match_uri(Uri uri)
    {
        String link = uri.toString();
        {
           ...
           else if(link.contentEquals(DatabaseContract.ScoresItem.buildScoreWithDate().toString()))
           {
               return MATCHES_WITH_DATE;
           }
           else if(link.contentEquals(DatabaseContract.ScoresItem.buildScoreWithId().toString()))
           {
               return MATCHES_WITH_ID;
           }
           else if(link.contentEquals(DatabaseContract.ScoresItem.buildScoreWithLeague().toString()))
           {
    ...
    public String getType(Uri uri)
    {
        ...
        switch (match) {
            case MATCHES:
                return DatabaseContract.ScoresItem.CONTENT_TYPE;
            case MATCHES_WITH_LEAGUE:
                return DatabaseContract.ScoresItem.CONTENT_TYPE;
            case MATCHES_WITH_ID:
                return DatabaseContract.ScoresItem.CONTENT_ITEM_TYPE;
